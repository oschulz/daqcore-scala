...
class SIS3300_03(vmeBus: VMEBus, baseAddress: Int) extends SIS3300(vmeBus, baseAddress) {
  import SIS3300._

  val memory = new SISMemory03
  ...
  class SISMemory03 extends SISMemory {
...
object SIS3300_03 {  
  def apply (vmeBus: VMEBus, baseAddress: Int) : SIS3300_03 =
    start(new SIS3300_03(vmeBus, baseAddress))
  
  def apply (host: String, port: Int, baseAddress: Int) : SIS3300_03 =
    SIS3300_03(VMESCPIClient(host, port), baseAddress)
}
