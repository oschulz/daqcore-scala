...
addCompilerPlugin("org.scala-lang.plugins" % "continuations" % "2.10.0-RC5")

Classpaths.compilerPluginConfig

scalacOptions ++= Seq("-unchecked", "-deprecation", "-P:continuations:enable")

libraryDependencies += "org.scala-lang" % "scala-swing" % "2.10.0-RC5"

libraryDependencies += "org.scala-lang" % "jline" % "2.10.0-RC5" % "runtime"
...
libraryDependencies += "com.typesafe.akka" %% "akka-actor" % "2.1.0-RC6"

libraryDependencies += "com.typesafe.akka" %% "akka-remote" % "2.1.0-RC6"

libraryDependencies += "com.typesafe.akka" %% "akka-agent" % "2.1.0-RC6"

libraryDependencies += "com.typesafe.akka" %% "akka-transactor" % "2.1.0-RC6"

libraryDependencies += "com.typesafe.akka" %% "akka-slf4j" % "2.1.0-RC6"


libraryDependencies += "org.scalatest" %% "scalatest" % "2.0.M5-B1" % "test"
